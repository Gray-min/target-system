...
<form id="form" action="${z:u('change_pass')}" method="post">
    <table align="left" class="form-table" style="margin:40px 50px">
    	<tr>
			<td>账号：</td>
			<td colspan="4" >
				<input class="w200" name="name" class="jq-validatebox" readonly="readonly"  value='${sessionScope.account}' type="text" data-options="required:true">
			</td>
		</tr>
		<tr>
			<td>原密码：</td>
